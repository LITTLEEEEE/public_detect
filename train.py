...
if __name__ == "__main__":
    ...
    # 获取classes和anchor的位置
    classes_path = 'model_data/public.txt'
    anchors_path = 'model_data/yolo_anchors.txt'
    weights_path = 'model_data/init.h5'
    # 获得classes和anchor
    ...
    #   也可以在训练初期防止权值被破坏。
    freeze_layers = 302 #262是cspdarknet
    ...
    if True:
        ...
        if Cosine_scheduler:
            # 预热期
            warmup_epoch = int((Freeze_epoch-Init_epoch)*0.1)
            # 总共的步长
    ...
    if True:
        ...
        if Cosine_scheduler:
            # 预热期
            warmup_epoch = int((Epoch-Freeze_epoch)*0.1)
            # 总共的步长
